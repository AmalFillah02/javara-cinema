            ...
            <ul>
                ...
                <li data-transition="fade">
                    ...
                    <div class="tp-caption tp-resizeme" data-x="center" data-hoffset="" data-y="middle"
                        ...
                        data-fontsize="['60','50','40','30']" data-lineheight="['70','50','40','30']"
                        ...
                        style="z-index: 5; color: #fff; font-weight: 900;">Selamat Datang Di Javara Cinema</div>
                                ...
                                <div class="col-md-8 col-sm-10 col-12">
                                    <div class="form-group">
                                        <input name="search" type="text" id="search" value=""
                                            class="form-control" placeholder="Masukkan judul film">
                    ...
                    <div class="tp-caption tp-resizeme text-center" data-x="center" data-hoffset="" data-y="middle"
                        data-voffset="['100','100','80','80']" data-responsive_offset="on" data-fontsize="['25']"
